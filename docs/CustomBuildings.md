...
ComStock-Typical can create a complete typical model of a **custom building type**: a named mix of space types with custom area ratios, building form, schedule overrides, and internal load overrides. The space type mix comes in one of two forms:
