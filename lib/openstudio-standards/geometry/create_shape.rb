  ...
  module Geometry
    ...
    def self.create_shape_rectangle(model,
      ...
      for floor in ((under_ground_storys * -1)..above_ground_storys - 1)
        ...
        OpenstudioStandards::Geometry.surfaces_set_boundary_condition(underground_surfaces, 'Ground') if z < 0
      end

      OpenstudioStandards::Geometry.model_match_surfaces(model)
      return model
    end
    ...
    def self.create_shape_aspect_ratio(model,
      ...
      OpenstudioStandards::Geometry.model_rotate(model, rotation)
