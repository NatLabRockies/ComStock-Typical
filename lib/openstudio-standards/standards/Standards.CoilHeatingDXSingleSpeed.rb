class Standard
  ...
  def coil_heating_dx_single_speed_standard_minimum_cop(coil_heating_dx_single_speed, rename = false, equipment_type = false)
    ...
    search_criteria = coil_dx_find_search_criteria(coil_heating_dx_single_speed, equipment_type)
  ...
  def coil_heating_dx_single_speed_apply_efficiency_and_curves(coil_heating_dx_single_speed, sql_db_vars_map)
    ...
    cop = coil_heating_dx_single_speed_standard_minimum_cop(coil_heating_dx_single_speed, true, equipment_type)
