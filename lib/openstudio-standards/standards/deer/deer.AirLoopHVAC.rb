class DEER
  ...
  # Based on the MASControl rules, it appears that only FixedDryBulb economizers are used.
  #
  # Moved here from prototypes/deer/deer.Model.rb, which went with the prototype tree.
  #
  # @param model [OpenStudio::Model::Model] OpenStudio model object
  # @param climate_zone [String] DEER climate zone
  # @return [String] the economizer type
