class Standard
  ...
  def surface_subsurface_ua(surface)
    ...
    surface.subSurfaces.sort.each do |subsurface|
      ...
      unless u_factor
        OpenStudio.logFree(OpenStudio::Error, 'openstudio.standards.surface', "Failed to calculate subsurface #{subsurface_construction.name.get} u-factor. It is likely the subsurface construction is not defined or the model is not simulated.")
        next
      end
