class Standard
  ...
  def model_add_swh(model, building_type, prototype_input)
    ...
    unless prototype_input['main_water_heater_volume'].nil? || (building_type == 'TallBuilding' || building_type == 'SuperTallBuilding')
      ...
      unless building_type == 'RetailStripmall'
      ...
      if building_type == 'LargeOffice'
      ...
      elsif building_type == 'LargeOfficeDetailed'
        ...
        space_type_map.sort.each do |space_type_name, space_names|
          ...
          next unless !data['service_water_heating_peak_flow_rate'].nil? || !data['service_water_heating_peak_flow_per_area'].nil?
