module OpenstudioStandards
  ...
  module CreateTypical
    ...
    # @todo Phase 5: add deer_template_to_t24_template here, and retire every helper above it.
    #   DEER is kept only until the Title 24 data replaces it (decision D10 in the fork plan).
    #   The crosswalk data file, create_typical/data/deer_t24_equivalent.csv, ships with the
    #   title_24_data branch and is not on this branch yet.
  end
end
