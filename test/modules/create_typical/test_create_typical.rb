...
class TestCreateTypical < Minitest::Test
  ...
  def test_create_typical_building_from_model
    ...
    model = std.safe_load_model("#{File.dirname(__FILE__)}/../../models/geometry/ASHRAEPrimarySchool.osm")
  ...
  def test_create_typical_building_from_model_comstock
    ...
    climate_zone = 'ASHRAE 169-2013-4A'
    std = Standard.build(template)
    model = std.safe_load_model("#{File.dirname(__FILE__)}/../../models/geometry/ASHRAEMediumOffice.osm")
    OpenstudioStandards::Weather.model_set_building_location(model, climate_zone: climate_zone)
  ...
  def test_create_typical_deer_building_from_model
    ...
    std = Standard.build(template)
    model = std.safe_load_model("#{File.dirname(__FILE__)}/../../models/geometry/DEER_ESe.osm")
    OpenstudioStandards::Weather.model_set_building_location(model, climate_zone: climate_zone)
  ...
  def test_create_typical_building_from_model_with_hvac_mapping
    ...
    climate_zone = 'ASHRAE 169-2013-4A'
    std = Standard.build(template)
    model = std.safe_load_model("#{File.dirname(__FILE__)}/../../models/geometry/ASHRAESmallOffice.osm")
    OpenstudioStandards::Weather.model_set_building_location(model, climate_zone: climate_zone)
  ...
  def test_create_typical_building_from_model_comstock_restaurant
    ...
    std = Standard.build(template)
    model = std.safe_load_model("#{File.dirname(__FILE__)}/../../models/geometry/#{geometry_file}")
    OpenstudioStandards::Weather.model_set_building_location(model, climate_zone: climate_zone)
  ...
  def test_create_typical_building_from_model_comstock_retail_pthp
    ...
    climate_zone = 'ASHRAE 169-2013-4A'
    std = Standard.build(template)
    model = std.safe_load_model("#{File.dirname(__FILE__)}/../../models/geometry/ASHRAERetailStripmall.osm")
    OpenstudioStandards::Weather.model_set_building_location(model, climate_zone: climate_zone)
  ...
  def test_create_typical_laboratory_building
    ...
    climate_zone = 'ASHRAE 169-2013-4A'
    std = Standard.build(template)
    model = std.safe_load_model("#{File.dirname(__FILE__)}/../../models/geometry/ASHRAELaboratory.osm")
    OpenstudioStandards::Weather.model_set_building_location(model, climate_zone: climate_zone)
  ...
  def test_create_typical_comstock_supermarket
    ...
    climate_zone = 'ASHRAE 169-2013-4A'
    std = Standard.build(template)
    model = std.safe_load_model("#{File.dirname(__FILE__)}/../../models/geometry/ASHRAESuperMarket.osm")
    OpenstudioStandards::Weather.model_set_building_location(model, climate_zone: climate_zone)
  ...
  def test_create_typical_deer_gro
    ...
    std = Standard.build(template)
    model = std.safe_load_model("#{File.dirname(__FILE__)}/../../models/geometry/DEER_Gro.osm")
    OpenstudioStandards::Weather.model_set_building_location(model, climate_zone: climate_zone)
