...
class TestExteriorLightingCreate < Minitest::Test
  ...
  def test_create_typical_exterior_lighting
    ...
    path = OpenStudio::Path.new("#{__dir__}/../../models/example_model_multipliers.osm")
  ...
  def test_create_typical_exterior_lighting_small_hotel
    # Load the test model
    translator = OpenStudio::OSVersion::VersionTranslator.new
    path = OpenStudio::Path.new("#{__dir__}/../../models/SmallHotel_5B_2004.osm")
    model = translator.loadModel(path)
    model = model.get
  ...
  def test_create_typical_exterior_lighting_hospital
    # Load the test model
    translator = OpenStudio::OSVersion::VersionTranslator.new
    path = OpenStudio::Path.new("#{__dir__}/../../models/Hospital_4B_Pre1980.osm")
    model = translator.loadModel(path)
    model = model.get
  ...
  def test_create_typical_exterior_lighting_secondary
    # Load the test model
    translator = OpenStudio::OSVersion::VersionTranslator.new
    path = OpenStudio::Path.new("#{__dir__}/../../models/SecondarySchool_6A_1980-2004.osm")
    model = translator.loadModel(path)
    model = model.get
  ...
  def test_create_typical_exterior_lighting_quick_service
    # Load the test model
    translator = OpenStudio::OSVersion::VersionTranslator.new
    path = OpenStudio::Path.new("#{__dir__}/../../models/QuickServiceRestaurant_2A_2010.osm")
    model = translator.loadModel(path)
    model = model.get
