...
class TestSpace < Minitest::Test
  ...
  def test_spaces_get_occupancy_schedule
    ...
    # The tail of this test compared spaces_get_occupancy_schedule against the Appendix G
    # thermal_zone_get_annual_operating_hours, which went with the PRM machinery in Phase 2.
  end
end
